...
def extract_time_series_gee(mlmodel, sgrt_root, out_path, lat, lon, grid=None, name=None, footprint=50):
    ...
    return(es.ssm_ts_gee_alternative(lon, lat, Equi7XY[1], Equi7XY[2], footprint, name=name))